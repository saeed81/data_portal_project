     ...
     function ajaxFunction()
     {
         ...
         ajaxRequest.onreadystatechange=function() 
         {
             ...
             if (ajaxRequest.readyState==4 && ajaxRequest.status==200) {
                 ...
                 var vaj = "ajaxs.php?sum="+str.trim();
             
                 window.location.href = vaj;
                 
                 //window.open("ajaxs.php?sum="+str.trim())
                 //window.location.href="ajaxs.php?sum="+str.trim())
                 ...
                 //document.write("ajax output");
                 //document.write("<link type='text/css' rel='stylesheet' href='./css/layout_practice.css'>")
                 //document.write("<p id='pajax'></p>");
                 
                 //document.getElementById("pajax").innerHTML=ajaxRequest.responseText;
     ...
     function ajaxMatlab1()
     {
         ...
         ajaxRequest.onreadystatechange=function() 
         {
             ...
             if (ajaxRequest.readyState < 4) {                        // while waiting response from server
                 ...
                 document.getElementById("myImage").style.width = "25%";
                 document.getElementById("myImage").style.height = "25%";
...
<input type="submit" value="Your ajax result" id="ajr"/>
